# -*- coding: utf-8 -*-
"""
Created on Mon Aug 21 08:58:39 2023
...
# Creating a list of XGBoost models, one for each day in the forecast horizon
models = [XGBRegressor(n_estimators=100, random_state=42) for _ in range(forecast_horizon)]
...
for i, model in enumerate(models):
    ...
    # Update current input for the next prediction
    current_input = current_input.copy()
    current_input[0, 0] = predicted_rain  # Replace the first feature (rain) with the prediction
