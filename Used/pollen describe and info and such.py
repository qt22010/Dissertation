# -*- coding: utf-8 -*-
"""
Created on Wed Aug 16 08:21:58 2023
...
sns.barplot(x=average_pollen_by_month.index, y=average_pollen_by_month.values)
...
#Calculate and visualize correlations between pollen count and weather features (temperature, humidity, wind speed) as well as air quality features (PM2.5, PM10, NO2, O3). This can provide insights into the strength and direction of relationships.
