...
param_grid = {
    ...
    'learning_rate': [0.01],
    'dropout_rate': [0.2],  # Dropout rate for input layer (0 for no dropout)
    'num_lstm_layers': [1]
}
...
new_data1=pd.read_csv('rain_weather_30.csv')
...
last_week_data_scaled = (last_week_data_array  - mean) / std
...
predicted_temperatures_scaled = final_best_model.predict(last_week_sequence_final )
