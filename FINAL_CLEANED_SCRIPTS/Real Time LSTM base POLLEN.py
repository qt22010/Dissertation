...
# Load dataset
pre_data = pd.read_csv(r'C:\Users\white\Desktop\Dissertation\data\pollen\real time\pollen_weather_real_time.csv')

# Load donor dataset

donor = pd.read_csv(r'C:\Users\white\Desktop\Dissertation\data\donor_pollen.csv')
...
def build_model(units, learning_rate, dropout_rate, num_lstm_layers,num_nodes_per_layer):
    ...
    # Input LSTM layer
    model.add(LSTM(units=units, return_sequences=True, input_shape=X_scaled.shape[1:]))
